...
- Designed abstract class for WorkoutSession component
- Implemented all secondary methods for WorkoutSession
- Added toString, equals, and hashCode methods
- Added a WorkoutSet nested type

### Updated
- Revised the WorkoutSession kernel from Part 3
- Replaced removeSet(String exercise) with removeAnySet()
- Improved the kernel so secondary methods could be implemented using only kernel methods

```

Here `2026.03.24` would be the date of your submission, such as 2024.04.21.
