...
- **Tiyash Ghosh**: <!-- TODO: fill with first and last name (e.g., Brutus Buckeye) then delete this comment -->
- **ghosh.331**: <!-- TODO: fill with OSU dot number (e.g., buckeye.17) then delete this comment -->
- **4/24/26 @11:59**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) then delete this comment -->
...
I chose to move forward with the WorkoutSession component.This design allows me to demonstrate multiple methods, a clear representation, and a useful main method without getting stuck on difficult implementation details. It also connects to real-world use since it models a system that someone could use. Another reason I chose this design is because I understand how to break it into smaller parts. I know what fields I need, what methods make sense, and how a user would interact with it. This makes it a good choice for a proof-of-concept since I can focus on showing functionality instead of struggling with structure.
...
- Designed a proof of concept for WorkoutSession component

### Updated

- Changed design to include the original design to focus on tracking workout sessions instead of a broader fitness system

```

Here `2026.04.21` would be the date of your submission, such as 2024.04.21.
