...
- **Tiyash Ghosh**: <!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and delete this comment -->
- **ghosh.331**: <!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->
- **3/24 @11:59**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
Standard<WorkoutSession>
^
|
WorkoutSessionKernel
^
|
WorkoutSession

I kept WorkoutSession as my final component because it fit my interests and
worked well in the proof-of-concept. I made changes to improve the design for
the OSU discipline. I simplified the kernel so it only includes the most basic
methods like adding and removing sets and checking size. I moved methods like
totalVolume, bestSetLoad, and progressedFrom into the enhanced interface since
they are higher-level operations built from the kernel.
...
- Designed kernel and enhanced interfaces for WorkoutSession component
- Added a hierarchy diagram for the WorkoutSession component

### Updated

- Refined the WorkoutSession design after the proof-of-concept
- Simplified the kernel to include only the most basic workout operations
- Moved workout summary methods to the enhanced interface

```

Here `2026.04.24` would be the date of your submission, such as 2024.04.21.
